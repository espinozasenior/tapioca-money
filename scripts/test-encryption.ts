...
console.log(
  `Both decrypt correctly: ${decrypt(encrypted1) === plaintext && decrypt(encrypted2) === plaintext ? "✓" : "✗"}\n`
);
...
console.log(
  `Other fields unchanged: ${encryptedAuth.eoaAddress === agentAuth.eoaAddress ? "✓" : "✗"}`
);
...
console.log(
  `Match: ${decryptedAuth.sessionPrivateKey === agentAuth.sessionPrivateKey ? "✓" : "✗"}\n`
);
...
console.log(
  `Match: ${decryptedTransferAuth.sessionPrivateKey === transferAuth.sessionPrivateKey ? "✓" : "✗"}\n`
);
