/**
 * Morpho Pause Checker (ADR-001)
 * Reads on-chain paused() from MetaMorpho vault contracts.
 * MetaMorpho guardian can pause supply/withdraw — exposed as binary paused().
 */
...
export class MorphoPauseChecker implements VaultPauseChecker {
